...
#NODE_TAINTS="--register-with-taints="

# Bootstrap and join the cluster
/etc/eks/bootstrap.sh '${cluster_name}' --b64-cluster-ca '${cluster_auth_base64}' --apiserver-endpoint '${endpoint}' ${bootstrap_extra_args} --kubelet-extra-args "$NODE_LABELS"
